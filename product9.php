...
<head>
	...
	<meta name="description" content="gaming, game, gaming chair budget, gamer">
...
<body>
	...
	$query = "SELECT * FROM products WHERE productid = 9";
					...
					<div class='product'> 
						...
						<div class='productInfo'>
							...
							<div class='prodDescript'>
								<p>The RedEye Gaming Chair is designed for comfort so that you can play on, even after long gaming sessions. It is extremely affordable, compared to other gaming chairs. </p>
							</div>
						</div> 
						<div>
