...
<head>
	...
	<meta name="description" content="gaming, game, microphone, budget, gamer">
...
<body>
	...
	$query = "SELECT * FROM products WHERE productid = 10";
					...
					<div class='product'> 
						...
						<div class='productInfo'>
							...
							<div class='prodDescript'>
								<p>The Commander1 Microphone is a audio input device designed for gamers. You will never have any issues with your teammates hearing your voice when using ths mic! </p>
							</div>
						</div> 
						<div>
