...
<body>
	...
	$query = "SELECT * FROM products WHERE productid = 5";
					...
					<div class='product'> 
						...
						<div class='productInfo'>
							...
							<div class='prodDescript'>
								<p>The Altec Keyboard is a high-end gaming keyboard made by Altec. It's higher price tag correlates with its higher quality. However, markup on this keyboard is low and is a great product for anyone who aspires to be a pro gamer one day! </p>
							</div>
						</div> 
						<div>
