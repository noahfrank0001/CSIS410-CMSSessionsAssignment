					...
					<div class='product'> 
						...
						<div class='productInfo'>
							...
							<div class='prodDescript'>
								<p>The SealthHawk Keyboard is deisgned for intermediate-skilled gamers who want to upgrade their gaming setup on a budget. It has RGB backlighting that allows the user to customize the keyboard colors to their liking. Buy yours today. </p>
							</div>
						</div> 
						<div>
