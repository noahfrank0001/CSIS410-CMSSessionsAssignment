...
<body>
	...
	$query = "SELECT * FROM products WHERE productid = 3";
					...
					<div class='product'> 
						...
						<div class='productInfo'>
							...
							<div class='prodDescript'>
								<p> The EverLast keyboard integrates high quality keys, durability, and longevity, without demanding the high price tag that some of its competitors have. It is affordable and will upgrade your gaming setup! </p>
							</div>
						</div> 
						<div>
